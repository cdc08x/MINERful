...
public class ConstraintsBag implements Cloneable, PropertyChangeListener {
	...
	// @XmlTransient
	private Set<TaskChar> taskChars = new TreeSet<>();
	...
	/**
	 * Adds constraint for provided task character. If task character does not exist
	 * a new entry in the constraints bag is created.
	 * 
	 * @param taskChar   {@link TaskChar} for whom the constraint should be added
	...
	/**
	 * Adds task character to the constraints bag and the set of used task
	 * characters.
	 * 
	...
	/**
	 * Adds collection of constraints for a task character.
	 * 
	...
	/**
	 * Removes constraints for a specific task character.
	 * 
	...
	/**
	 * Removes constraint from every corresponding task character.
	 * 
	...
	public void setAlphabet(Collection<TaskChar> alphabet) {
		for (TaskChar taskChr : alphabet) {
			if (!this.bag.containsKey(taskChr)) {
				this.bag.put(taskChr, new TreeSet<>());
	...
	/**
	 * Checks if a task characters is in the alphabet of the constraint bag.
	 * 
	...
	public Collection<Constraint> getOnlyFullySupportedConstraints() {
		Collection<Constraint> constraints = new TreeSet<>();
		for (TaskChar tCh : this.getTaskChars()) {
