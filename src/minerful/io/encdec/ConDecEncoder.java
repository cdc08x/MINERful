...
//		NAME_CONVERTER.put(End.class, "end");
		...
		NAME_CONVERTER.put(Uniqueness.class, "absence2");
		// Relation
...
//		LTL_CONVERTER.put(End.class, "end");
		...
		LTL_CONVERTER.put(Uniqueness.class, "! ( <> ( ( \"A\" /\\ X(<>(\"A\")) ) ) )");
		// Relation
	...
	public ConDecEncoder(ProcessModel process) {
