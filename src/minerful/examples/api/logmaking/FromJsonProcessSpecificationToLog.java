 ...
 */
public class FromJsonProcessSpecificationToLog {
...
//		/* Alternative 3: load from another string version of the JSON specification. Uncomment the following line to use this method. */ 
