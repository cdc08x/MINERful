...
import minerful.checking.integration.prom.SpecificationFitnessEvaluatorOpenXesInterface;
...
public class FitnessCheckOfDiscoveredProcessSpecificationWithOpenXes {
...
//////////////////////////////////////////////////////////////////
		...
		// The language of the specification remains completely unchanged. What changes is the number of constraints in it.
...
//////////////////////////////////////////////////////////////////
		...
		SpecificationFitnessEvaluatorOpenXesInterface xEvalor = new SpecificationFitnessEvaluatorOpenXesInterface(
				myXLog,
...
//////////////////////////////////////////////////////////////////
		...
		SpecificationFitnessEvaluatorOpenXesInterface xEvalor3 = new SpecificationFitnessEvaluatorOpenXesInterface(
				myXLog3,
				ClassificationType.NAME,
				// // In case you opted for EventClassification.logspec in the discovery phase above, you might want to replace the previous line with the following
				// ClassificationType.LOG_SPECIFIED,
		...
		// Check the process specification extracted from EXAMPLE_LOG_FILE_1 against the first trace of EXAMPLE_LOG_FILE_3
