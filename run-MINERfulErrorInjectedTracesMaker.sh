...
## Run!
echo java -Xmx$MEMORY_MAX -jar MINERful.jar $MAINCLASS -a $alphabet -m $MIN_STRLEN -M $MAX_STRLEN -s $TESTBED_SIZE -eS ${errorSpreadTypeParams[0]} -eT ${errorTypeParams[2]} -eP 30 -eC $targetChar -r ${constraints[2]} ${constraints[5]} $*
